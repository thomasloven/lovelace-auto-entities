...
var RULES = {
  type: function () {
    var _type = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(hass, value) {
    ...
    function type(_x10, _x11) {
      return _type.apply(this, arguments);
    }
    return type;
  }(),
  options: function () {
    var _options = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(hass, value) {
    ...
    function options(_x12, _x13) {
      return _options.apply(this, arguments);
    }
    return options;
  }(),
  sort: function () {
    var _sort = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(hass, value) {
    ...
    function sort(_x14, _x15) {
      return _sort.apply(this, arguments);
    }
    return sort;
  }(),
  domain: function () {
    var _domain = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(hass, value) {
      var match;
    ...
    function domain(_x16, _x17) {
      return _domain.apply(this, arguments);
    }
    return domain;
  }(),
  entity_id: function () {
    var _entity_id = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(hass, value) {
      var match;
    ...
    function entity_id(_x18, _x19) {
      return _entity_id.apply(this, arguments);
    }
    return entity_id;
  }(),
  state: function () {
    var _state = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(hass, value) {
      var match;
    ...
    function state(_x20, _x21) {
      return _state.apply(this, arguments);
    }
    return state;
  }(),
  name: function () {
    var _name = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(hass, value) {
      var match;
    ...
    function name(_x22, _x23) {
      return _name.apply(this, arguments);
    }
    return name;
  }(),
  group: function () {
    var _group = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee10(hass, value) {
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            return _context10.abrupt("return", function (entity) {
              var _a, _b, _c;
    ...
    function group(_x24, _x25) {
      return _group.apply(this, arguments);
    }
    return group;
  }(),
  attributes: function () {
    var _attributes = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee12(hass, value) {
      var matchers;
        ...
        while (1) switch (_context12.prev = _context12.next) {
          case 0:
            ...
            return Promise.all(Object.entries(value).map(/*#__PURE__*/function () {
              var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11(_ref4) {
    ...
    function attributes(_x26, _x27) {
      return _attributes.apply(this, arguments);
    }
    return attributes;
  }(),
  not: function () {
    var _not = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee13(hass, value) {
      var filter;
    ...
    function not(_x29, _x30) {
      return _not.apply(this, arguments);
    }
    return not;
  }(),
  and: function () {
    var _and = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee14(hass, value) {
      var filters;
    ...
    function and(_x31, _x32) {
      return _and.apply(this, arguments);
    }
    return and;
  }(),
  or: function () {
    var _or = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee15(hass, value) {
      var filters;
    ...
    function or(_x33, _x34) {
      return _or.apply(this, arguments);
    }
    return or;
  }(),
  device: function () {
    var _device = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee16(hass, value) {
    ...
    function device(_x35, _x36) {
      return _device.apply(this, arguments);
    }
    return device;
  }(),
  device_manufacturer: function () {
    var _device_manufacturer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee17(hass, value) {
    ...
    function device_manufacturer(_x37, _x38) {
      return _device_manufacturer.apply(this, arguments);
    }
    return device_manufacturer;
  }(),
  device_model: function () {
    var _device_model = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee18(hass, value) {
    ...
    function device_model(_x39, _x40) {
      return _device_model.apply(this, arguments);
    }
    return device_model;
  }(),
  area: function () {
    var _area = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee19(hass, value) {
    ...
    function area(_x41, _x42) {
      return _area.apply(this, arguments);
    }
    return area;
  }(),
  entity_category: function () {
    var _entity_category = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee20(hass, value) {
    ...
    function entity_category(_x43, _x44) {
      return _entity_category.apply(this, arguments);
    }
    return entity_category;
  }(),
  last_changed: function () {
    var _last_changed = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee21(hass, value) {
      var match;
    ...
    function last_changed(_x45, _x46) {
      return _last_changed.apply(this, arguments);
    }
    return last_changed;
  }(),
  last_updated: function () {
    var _last_updated = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee22(hass, value) {
      var match;
    ...
    function last_updated(_x47, _x48) {
      return _last_updated.apply(this, arguments);
    }
    return last_updated;
  }(),
  last_triggered: function () {
    var _last_triggered = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee23(hass, value) {
      var match;
    ...
    function last_triggered(_x49, _x50) {
      return _last_triggered.apply(this, arguments);
    }
    return last_triggered;
  }(),
  integration: function () {
    var _integration = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee24(hass, value) {
      ...
      return _regeneratorRuntime().wrap(function _callee24$(_context24) {
        while (1) switch (_context24.prev = _context24.next) {
          case 0:
            ...
            return Promise.all([matcher(value), getEntities(hass)]);
          case 2:
            _yield$Promise$all11 = _context24.sent;
    ...
    function integration(_x51, _x52) {
      return _integration.apply(this, arguments);
    }
    return integration;
  }(),
  hidden_by: function () {
    var _hidden_by = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee25(hass, value) {
      ...
      return _regeneratorRuntime().wrap(function _callee25$(_context25) {
        while (1) switch (_context25.prev = _context25.next) {
          case 0:
            ...
            return Promise.all([matcher(value), getEntities(hass)]);
          case 2:
            _yield$Promise$all13 = _context25.sent;
    ...
    function hidden_by(_x53, _x54) {
      return _hidden_by.apply(this, arguments);
    }
    return hidden_by;
  }(),
  label: function () {
    var _label = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee26(hass, value) {
      ...
      return _regeneratorRuntime().wrap(function _callee26$(_context26) {
        while (1) switch (_context26.prev = _context26.next) {
          ...
          case 2:
            _yield$Promise$all15 = _context26.sent;
            ...
            return _context26.abrupt("return", function (entity) {
              var ent = entities.find(function (e) {
                return e.entity_id === entity.entity_id;
              });
              if (!ent) return false;
    ...
    function label(_x55, _x56) {
      return _label.apply(this, arguments);
    }
    return label;
  }()
};
function get_filter(_x57, _x58) {
...
var COMPARISONS = {
  ...
  device: function () {
    var _device2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee27(x, m, hass) {
      ...
      return _regeneratorRuntime().wrap(function _callee27$(_context27) {
        while (1) switch (_context27.prev = _context27.next) {
          ...
          case 2:
            _yield$Promise$all17 = _context27.sent;
          ...
          case 9:
            ...
            return _context27.abrupt("return", undefined);
          case 12:
            return _context27.abrupt("return", (_c = dev.name_by_user) !== null && _c !== void 0 ? _c : dev.name);
          case 13:
          case "end":
    ...
    function device(_x59, _x60, _x61) {
      return _device2.apply(this, arguments);
    }
    return device;
  }(),
  area: function () {
    var _area2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee28(x, m, hass) {
      ...
      return _regeneratorRuntime().wrap(function _callee28$(_context28) {
        while (1) switch (_context28.prev = _context28.next) {
          ...
          case 2:
            _yield$Promise$all19 = _context28.sent;
          ...
          case 10:
            ...
            return _context28.abrupt("return", area.name);
          case 13:
            dev = devices.find(function (d) {
              return d.id === ent.device_id;
            });
...
function _selectTree(_x68, _x69) {
...
var ruleSchema = function ruleSchema(_ref10, idx) {
  ...
  return {
    type: "grid",
    name: "",
    schema: [Object.assign(Object.assign({}, ruleKeySelector), {
  ...
  return _createClass(AutoEntities, [{
    ...
    value: function setConfig(config) {
      ...
      if (config.filter.include) {
        var _iterator14 = _createForOfIteratorHelper(config.filter.include.entries()),
          _step14;
        try {
      ...
      if (config.filter.exclude) {
        var _iterator15 = _createForOfIteratorHelper(config.filter.exclude.entries()),
          _step15;
        try {
